                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
                    <div class="card border-0">
                        <div class="footer-body card-body text-center">
                            ...
                            <p class="d-inline lead text-white"><b>Spacely</b> is a discussion forum website about programming
                            that aims to be the medium for developers in Indonesia to learn and discuss together.
                            </p><br>
