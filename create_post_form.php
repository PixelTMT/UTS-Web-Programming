                    ...
                    <div class="card-body">
                        <form action="create_post_proses.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="content-container d-flex flex-column">
                                ...
                                <textarea placeholder="Your post here..." type="text" class="form-control mb-3" id="body" name="body" required style="height: 250px" aria-label="floating label"></textarea>
